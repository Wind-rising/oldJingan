    ...
    return{
        init: function () {
            $.fn.setFormDatas = function (data, forceOverwrite) {
                ...
                var url = form.attr("available_action") + "?cb_key=" + $(element).attr("available_name");
                var id = $(element).attr('available_id');
                if (id.size() > 0) {
                    url = url + "&id=" + id.val()
                }
            ...
            var idCardNoUtil = {
                provinceAndCitys: {11: "北京", 12: "天津", 13: "河北", 14: "山西", 15: "内蒙古", 21: "辽宁", 22: "吉林", 23: "黑龙江", 31: "上海", 32: "江苏", 33: "浙江", 34: "安徽", 35: "福建", 36: "江西", 37: "山东", 41: "河南", 42: "湖北", 43: "湖南", 44: "广东", 45: "广西", 46: "海南", 50: "重庆", 51: "四川", 52: "贵州", 53: "云南", 54: "西藏", 61: "陕西", 62: "甘肃", 63: "青海", 64: "宁夏", 65: "新疆", 71: "台湾", 81: "香港", 82: "澳门", 99: "其他"},
            ...
            $("form.form-validation", $container).each(function () {
                ...
                $first.focus();
                $form.validate({errorElement: "span", errorClass: "error-block", focusInvalid: true, ignore: "", errorPlacement: function (error, element) {
                    ...
                    $errorAlert.show();
                    Metronic.scrollTo($errorAlert, -200)
                    ...
                    if (dataGridSearch) {
                        ...
                        var data = {datatype: "json", url: url};
                    ...
                    if (dataLoadTarget) {
                        ...
                        $.ajax({type: "GET", cache: false, url: url, dataType: "html", success: function (res) {
                            $content.empty();
                    ...
                    $(form).ajaxSubmit({dataType: "json", method: "post", data: postData, success: function (response) {
                        Metronic.unblockUI($form);
                        if (response.code == 200) {
                            Global.notify('success', response.msg);
                            ...
                            if (options.successCallback) {
                                ...
                                if (dataGridReload) {
                                    $(dataGridReload).jqGrid("setGridParam", {datatype: "json"}).trigger("reloadGrid")
                                }
                                ...
                                if (ajaxifyReload) {
                                    if (ajaxifyReload == "_page") {  // added by horse, 2015-7-30
                                        location.reload();           // added by horse, 2015-7-30
                                    } else if (ajaxifyReload == "_active-panel") {
                            ...
                            if (response.code>0) {
                                if (options.failureCallback) {
                                    ...
                                    Global.notify("error", response.msg)
                                }
                            } else {
                ...
                $form.find("input[type='text'],input[type='password'],select,textarea,hidden").each(function () {
                    ...
                    if ($el.attr("data-tooltips")) {
                        ...
                        $tips.tooltipster({contentAsHTML: true, offsetY: 5, theme: "tooltipster-punk"});
