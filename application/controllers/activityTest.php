...
class Activitytest extends My_Controller {
    ...
    public function index()
    {
        ...
        if (empty($openid)) {
            header('Location: https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxa9da81f585c9d3b0&redirect_uri=http%3A%2F%2Fwx.wuliqinggu.com%2Factivitytest%2Findex&response_type=code&scope=snsapi_base&state=1#wechat_redirect');
            die();
